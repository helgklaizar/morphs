...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { title: "Посадка", url: "/tables", icon: Coffee, moduleId: "tables" },
      { title: "История заказов", url: "/orders-history", icon: History, moduleId: "orders" },
    ],
  },
  {
    label: "CRM и Маркетинг",
    items: [
      { title: "Клиенты", url: "/clients", icon: Users, moduleId: "crm" },
      { title: "Лояльность", url: "/loyalty", icon: Briefcase, moduleId: "crm" },
      { title: "Акции и Баннеры", url: "/marketing", icon: Megaphone, moduleId: "marketing" },
      { title: "Промокоды", url: "/promocodes", icon: Flame, moduleId: "marketing" },
    ],
  },
  {
    label: "Производство",
    ...
    items: [
      ...
      { title: "Заготовки", url: "/preparations", icon: Coffee },
      { title: "Рецепты", url: "/recipes", icon: Package },
      { title: "Сборки", url: "/assemblies", icon: Layers },
    ],
  },
  {
    label: "Склад и Поставки",
    items: [
      { title: "Склад", url: "/inventory", icon: Package, moduleId: "inventory" },
      { title: "Закупки", url: "/procurement", icon: Bot, moduleId: "procurement" },
      { title: "Поставщики", url: "/suppliers", icon: Truck, moduleId: "procurement" },
    ],
  },
  {
    label: "Персонал",
    moduleId: "workers",
    items: [
      { title: "Сотрудники", url: "/workers", icon: Users },
      { title: "Смены / Часы", url: "/shifts", icon: Clock },
    ],
  },
  {
    label: "Аналитика",
    ...
    items: [
      ...
      { title: "Финансы", url: "/dashboard?tab=finance", icon: DollarSign },
      { title: "Продажи", url: "/dashboard?tab=sales", icon: UtensilsCrossed },
      { title: "Склад", url: "/dashboard?tab=inventory", icon: Warehouse },
      { title: "Нагрузка", url: "/dashboard?tab=workload", icon: Flame },
      { title: "Heatmap", url: "/dashboard?tab=heatmap", icon: Map },
    ],
  },
  {
    label: "Система",
