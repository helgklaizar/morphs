import { InventoryCategory, Assembly, Recipe, Order } from '@borsch/types';
...
export const mockInventoryCategories: InventoryCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'inv_sticker', name: 'Наклейка Borsch', price: 50, recipeUnit: 'шт', unit: 'рулон', packSize: 500, quantity: 1, categoryId: 'cat_pack', yieldPerUnit: 500 },
    ]
  }
];
...
export const mockAssemblies: Assembly[] = [
  {
    ...
    items: [
      ...
      { id: 'asm_item_2', name: 'Наклейка Borsch', quantity: 1, unit: 'шт', inventoryItemId: 'inv_sticker' }
    ]
  }
];
