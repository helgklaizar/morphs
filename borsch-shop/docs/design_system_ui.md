...
В данном документе описана визуальная система (Design System) админки Borsch Shop, ее компоненты и стилевые решения. Приложение построено на `React`, стилизуется через `Tailwind CSS`, иконки предоставляются `lucide-react`.
